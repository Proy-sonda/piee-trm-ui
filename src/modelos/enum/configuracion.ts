export enum ENUM_CONFIGURACION {
  MONTO_MAXIMO_RENTA = 'MtoMaxRentasPeriodo',
  MONTO_MAXIMO_ULTIMA_RENTA = 'MtoMaxUltimaRenta',
  VALIDA_INGRESO_HABERES = 'ValidIngresoHaberes',
