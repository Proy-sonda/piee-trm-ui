...
import { Actividadlaboral, Administrador, Ccaf, Comuna, Empleador, Tamanoempresa, Tipoempleador, Sistemaremuneracion, DireccionEmpleador } from '../interface/adscripcion';
